...
"""
['a_etoile_seul','suivre_chemin','pomme_moins_queue','raccourcis_croissants_v2','raccourcis_croissants_v3','a_etoile_seulement_si_modif','a_etoile_graphe_oriente']
"""
a_plot=['a_etoile_seul','suivre_chemin','pomme_moins_queue','raccourcis_croissants_v2','raccourcis_croissants_v3','a_etoile_seulement_si_modif','a_etoile_graphe_oriente']
...
if plot_a_faire in ['methodes_individuelles','nb_pas','nb_pas_total','temp']:
    for numero_colonne,nom_feuille in enumerate(fichier.sheetnames,start=0):
        ...
        for i in range(donnees.score_max):
            ...
            nb_parties_total=feuille['C'+str(2)].value
            ...
            liste_essais.append(nb_parties/nb_parties_total)
        ...
        if 'temp' == plot_a_faire:
            # nb essais en fonction du score
            axe_primaire.plot(liste_score,liste_essais,color=couleurs[numero_colonne])
