...
axe_defaites2=axe_primaire.twinx()
...
for numero_colonne,nom_feuille in enumerate(fichier.sheetnames,start=0):
    ...
    axe_defaites2.plot(liste_ratio_defaite_tronquee,liste_nb_pas_total,color=couleurs[numero_colonne],alpha=0.6,linewidth=0.8,linestyle='-')
