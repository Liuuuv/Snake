...
def avoir_couplage_parfait(graphe_,liste_sommets_a_enlever=None):
    ...
    while not nx.is_perfect_matching(graphe,couplage):
        ...
        # cas ou le couplage ne peut pas etre amélioré
        # if longueur_couplage==len(liste_sommets_couplage):
        #     compteur+=1
        # else:
        #     compteur=0
        # if len(liste_sommets_departs_traites)==2*graphe.number_of_nodes():
        ...
        # longueur_couplage=len(liste_sommets_couplage)
        ...
        if sommet_final is None:
            ...
            liste_sommets_departs_traites.append(sommet_depart)
            continue
        else:
            liste_sommets_departs_traites=[]
